    ...
    var m, t, u, f, D, j, E, n, z, A, q = 0,
        ...
        I = function () {
            ...
            if (w === false) h = false;
                ...
                if (e.orig && e.titleFromAlt && e.orig.attr("alt") != '') k = e.orig.attr("alt");
                ...
                if (g) {
                    ...
                    e.paddingLeftRight = parseInt(e.paddingLeftRight, 10);
                    e.margin = parseInt(e.margin, 10);
                    m.css("padding", e.padding + e.margin);
                    m.css({paddingLeft:e.paddingLeftRight+e.margin,paddingRight:e.paddingLeftRight+e.margin});
            ...
            if (f.is(":visible") && false === d.onCleanup(l, p, d)) {
                ...
                if (d.titleShow !== false) {
                    ...
                    if (!(!s || s === "")) {
                        ...
                        case "inside":
                            n.css({
                                width: i.width - ((d.paddingLeftRight) * 2),
                                marginLeft: d.paddingLeftRight,
                                marginRight: d.paddingLeftRight
                            });
                ...
                if (f.is(":visible")) {
                    ...
                    j.fadeTo(d.changeFade, 0.3, function () {
                        ...
                        j.empty().removeAttr("filter").css({
                            "border-left-width": d.paddingLeftRight,
                            "border-right-width": d.paddingLeftRight,
                            "border-top-width": d.padding,
                            "border-bottom-width": d.padding,
                            width: i.width - ((d.paddingLeftRight) * 2),
                    ...
                    f.removeAttr("style");
                    j.css({"border-left-width": d.paddingLeftRight,
                            "border-right-width": d.paddingLeftRight,
                            "border-top-width": d.padding,
                            "border-bottom-width": d.padding});
        ...
        T = function (a) {
            ...
            f.css(c);
            j.css({
                width: c.width - (d.paddingLeftRight) * 2,
        ...
        X = function () {
            var a = U(),
                ...
                g = d.autoScale,
                k = d.padding * 2;
                k_lr = d.paddingLeftRight * 2;
            
            
            
            c.width = d.width.toString().indexOf("%") > -1 ? parseInt(a[0] * parseFloat(d.width) / 100, 10) : d.width + k_lr;
            ...
            if (g && (c.width > a[0] || c.height > a[1])) if (e.type == "image" || e.type == "swf") {
                ...
                if (c.width > a[0]) {
                    c.width = a[0];
                    c.height = parseInt((c.width - k_lr) / g + k, 10)
                }
                if (c.height > a[1]) {
                    c.height = a[1];
                    c.width = parseInt((c.height - k) * g + k_lr, 10)
                }
            } else {
        ...
        V = function () {
            ...
            if (a && a.length) {
                ...
                c = {
                    ...
                    left: c.left - (d.paddingLeftRight) - 20
                }
            } else {
            	
                a = U();
                c = {
                    width: (d.paddingLeftRight) * 2,
                    height: d.padding * 2,
    ...
    b.fancybox.center = function (a) {
        ...
        if (!h) {
            ...
            !g && (f.width() > c[0] || f.height() > c[1]) || f.stop().animate({
                ...
                left: parseInt(Math.max(c[2] - 20, c[2] + (c[0] - j.width() - 40) * 0.5 - (d.paddingLeftRight)))
